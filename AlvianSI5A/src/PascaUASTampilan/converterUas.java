 ...
 */
package PascaUASTampilan;

import PascaUAS.RumusUas;
 ...
 * @author lab3
 */
public class converterUas extends javax.swing.JFrame {
    RumusUas convert;
    /** Creates new form converter */
    public converterUas() {
        initComponents();
        convert = new RumusUas();
        hasilnya.setEditable(false);
    }
...
// TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(converterUas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                new converterUas().setVisible(true);
            }
        });
    }
